...
# Step 2: Load Dataset
# (Ensure you have downloaded the dataset from: https://www.kaggle.com/datasets/ziya07/power-system-faults-dataset)
...
label_col = 'Fault Type'  # Assuming the dataset has this column
